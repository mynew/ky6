...
☆-Powered by www.wtyui.xyz2019 All Rights Reserved     
...
☆-Powered by www.wtyui.xyz 2019 All Rights Reserved     
...
Host='github.com/dxb134111/ky6/raw/master';export Host=$Host
...
# APP软件客服
echo
echo -n -e "请输入APP客服QQ [默认:565961380 ]"
read adminqq
if [ -z $adminqq ]
then
	adminqq=565961380
...
# echo
# echo -n -e "请输入博客地址：[\033[32m www.xiaoyangren.vip\033[0m ]："
# read key
# if [[ $key == 'www.xiaoyangren.vip' ]]
# then
	# echo
